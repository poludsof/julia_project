function h_vals(sm::Subset_minimal, (I3, I2, I1), num_samples)
...
function heuristic(sm::Subset_minimal, (I3, I2, I1), confidence, num_samples)
    hs = h_vals(sm, (I3, I2, I1), num_samples)
    (;
...
function max_error(sm::Subset_minimal, (I3, I2, I1), confidence, num_samples)
    hs = h_vals(sm, (I3, I2, I1), num_samples)
...
function find_best(sm::Subset_minimal, (I3,I2,I1), confidence, num_samples)
    ii₁ = map(setdiff(1:784, I3)) do i
        Iᵢ = push(I3, i)
        (;ii = (Iᵢ, I2, I1), h = heuristic(sm, (Iᵢ, I2, I1), confidence, num_samples))
    end
    ii₂ = map(setdiff(1:256, I2)) do i
        Iᵢ = push(I2, i)
        (;ii = (I3, Iᵢ, I1), h = heuristic(sm, (I3, Iᵢ, I1), confidence, num_samples))
    end
    ii₃ = map(setdiff(1:256, I1)) do i
        Iᵢ = push(I1, i)
        (;ii = (I3,I2, Iᵢ), h = heuristic(sm, (I3, I2, Iᵢ), confidence, num_samples))
    end
